...
const Intro = () => {
    return (
        <article className="flex flex-col md:flex-row justify-center my-10 py-10 md:w-3/4 mx-auto">
            <h1 className="md:w-2/5 mx-10 my-5 font-semibold text-b-900 text-3xl xl:text-4xl md:text-right">BUILDING MANAGEMENT <br className="hidden md:block" />SYSTEM <span className="text-black"> (BMS)</span></h1>
