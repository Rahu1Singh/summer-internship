...
const Header = () => {
	return (
		<section id="header" className='relative z-10 left-0 top-0 w-full h-[200px] xl:h-[460px] p-10 flex items-center lg:mb-10 border-b-[20px] border-b-800 rounded-bl-3xl rounded-br-3xl overflow-clip' style={{backgroundImage:"url(https://letstranzact.com/_ipx/f_png/production_line.jpg)", backgroundSize: "cover", backgroundPosition: "100% 50%"}}>
			...
			<h1 className='absolute bottom-16 left-[10%] text-5xl xl:text-6xl font-bold text-white z-20'>Process <br/> Automation</h1>
		</section>
	)
}
...
const Intro = () => {
    return (
        <article className="flex flex-col md:flex-row justify-center my-10 py-10 md:w-3/4 mx-auto">
            <h1 className="md:w-2/5 mx-10 my-5 font-semibold text-b-900 text-3xl xl:text-4xl md:text-right">PROCESS <br className="hidden md:block" />AUTOMATION</h1>
