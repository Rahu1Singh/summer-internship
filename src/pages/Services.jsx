...
const ServiceCard = ({children, img}) => {
  return (
    	<div className="relative my-20">
			...
			<div className="hidden xl:block absolute w-4/5 h-full top-[30px] left-[12%] bg-b-700 rounded-3xl" aria-hidden="true" />
    	</div>
  	)
}
...
const AutomationContent = () => {
	return (
		<div className="relative flex flex-col text-left lg:mx-10">
...
const EngineeringContent = () => {
	return (
		<div className="relative flex flex-col text-left p-2 lg:mx-10">
