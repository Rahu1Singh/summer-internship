    ...
    return (
        <main className="bg-b-100">
            ...
            <section className="flex flex-col items-center p-8">
                <h1 className='relative text-b-900 font-semibold text-3xl max-xl:text-3xl my-4'>SERVERS</h1>
                ...
                <h1 className='relative text-b-900 font-semibold text-3xl max-xl:text-3xl my-4'>SERVER RACKS</h1>
                <div className="flex lg:w-2/3 items-center mb-5 p-5 border-2 border-b-800 lg:rounded-3xl bg-b-200">
                    ...
                    <p className='lg:w-2/3 text-lg lg:m-5'>A server rack is a standardized frame or enclosure designed to house and organize multiple pieces of IT equipment, including servers, network switches, routers, and other data center components.
                    <ul>We provide:
                ...
                <h1 className='relative text-b-900 font-semibold text-3xl max-xl:text-3xl my-4'>SWITCHES</h1>
                <div className="flex lg:w-2/3 items-center mb-5 p-5 border-2 border-b-800 lg:rounded-3xl bg-b-200">
                ...
                <h1 className='relative text-b-900 font-semibold text-3xl max-xl:text-3xl my-4'>WORKSTATIONS</h1>
                <div className="flex lg:w-2/3 items-center mb-5 p-5 border-2 border-b-800 lg:rounded-3xl bg-b-200">
                    ...
                    <p className='lg:w-2/3 text-lg lg:m-5'>A workstation is a high-performance computer designed for technical or scientific applications. Workstations are optimized for tasks that require significant computing power, advanced graphics capabilities, and high levels of reliability and efficiency.</p>
                </div>
            </section>
        </main>
    )
