  ...
  return (
    <main className="bg-b-100 pb-10">
      ...
      <article className=' max-lg:hidden flex flex-col items-center my-16 p-10'>
        <h1 className='relative text-g-600 font-semibold text-3xl max-xl:text-3xl mb-4'>INGENIUM - FIRE EXPERT</h1>
      ...
      <article className=' max-lg:hidden flex flex-col items-center my-8 p-10'>
        <h1 className='relative text-g-600 font-semibold text-3xl max-xl:text-3xl mb-4'>INGENIUM - SECURITY EXPERT</h1>
