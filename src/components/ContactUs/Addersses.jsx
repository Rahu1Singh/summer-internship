    ...
    return (
        <section className="relative bg-b-100 p-10 flex flex-col items-center">
            ...
            <div className="relative flex flex-col lg:flex-row">
                {/* Singapore Section */}
                <div className="relative z-10 flex flex-col p-5 mx-auto my-5 lg:m-5 w-full border-2 bg-whitebg border-b-[20px] border-b-800 rounded-bl-3xl rounded-br-3xl rounded-3xl xl:min-w-[700px]">
                    ...
                    <article className="w-full h-full rounded-3xl flex flex-col justify-center">
                        ...
                        <img src={singapore1qr} className="w-[150px] my-5"/>
                    </article>
                    ...
                    <article className="w-full h-full rounded-3xl flex flex-col justify-center">
                        ...
                        <img src={singapore2qr} className="w-[150px] my-5"/>
                    </article>
                    </div>
                </div>
                ...
                <div className="relative z-10 flex flex-col p-5 mx-auto my-5 lg:m-5 w-full border-2 bg-whitebg border-b-[20px] border-b-800 rounded-bl-3xl rounded-br-3xl rounded-3xl xl:min-w-[700px]">
                    ...
                    {/* Indonesia Section */}
                        ...
                        <article className="w-full rounded-3xl flex flex-col justify-end">
                            ...
                            <img src={indonesiaqr} className="w-[150px] mt-10"/>
                        </article>
                        </div>
                    </div>
                </div>
