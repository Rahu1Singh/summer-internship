        ...
        <div className='relative bg-g-100 my-16 p-10 overflow-hidden flex'>
            ...
            <div className='relative w-full 2xl:w-1/2 flex flex-col items-center z-40 my-auto'>
                <div className="flex flex-col xl:w-1/2 my-3">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={mobileaccess} className="h-[50px] mx-3" aria-hidden="true" />
                        <div>
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={security} className="h-[50px] mx-3" aria-hidden="true" />
                        <div>
            ...
            <div className='absolute -top-[150px] right-[100px] h-[800px] w-[800px] z-20 rounded-[50%] bg-g-200' aria-hidden="true" />
            <div className='absolute -top-[250px] right-[0px] h-[1000px] w-[1000px] z-10 rounded-[50%] bg-g-300' aria-hidden="true" />
            <div className='absolute -top-[350px] -right-[100px] h-[1200px] w-[1200px] z-0 rounded-[50%] bg-g-400' aria-hidden="true" />
        </div>
    )
}
