...
const EcostruxureBMS = () => {
    return (
        <div className='relative bg-g-100 my-16 p-10 overflow-hidden flex'>
            <div className='relative w-full 2xl:w-1/2 flex flex-col items-center z-40 my-auto'>
                ...
                <div className="flex flex-col xl:w-1/2 my-3">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={ipicon} className="h-[50px] mx-3"/>
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={enterprise} className="h-[50px] mx-3"/>
                        <div className="flex flex-col">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={edgecontrol} className="h-[50px] mx-3"/>
                        <div className="flex flex-col">
            ...
            <div className='absolute -top-[150px] left-[100px] h-[800px] w-[800px] z-20 rounded-[50%] bg-g-200'/>
            <div className='absolute -top-[250px] left-[0px] h-[1000px] w-[1000px] z-10 rounded-[50%] bg-g-300'/>
            <div className='absolute -top-[350px] -left-[100px] h-[1200px] w-[1200px] z-0 rounded-[50%] bg-g-400'/>
        </div>
    )
}
