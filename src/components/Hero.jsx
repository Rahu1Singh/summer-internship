...
const Hero = () => {
    ...
    return (
    <div className='flex flex-row top-0 left-0 w-screen absolute bg-b-100 px-60' ref={parallaxRef}>
        <div className='flex flex-col py-[15rem]'>
            ...
            <div className='py-3 flex items-center justify-start'><FaCheckSquare size={32} className='mr-4 text-b-800'/><p className='text-[20px]'>Efficiency Amplified: Redefining Industry Standards in Automation & IT Solutions.</p></div>
            <div className='py-3 flex items-center justify-start'><FaCheckSquare size={32} className='mr-4 text-b-800'/><p className='text-[20px]'>Pioneering Innovation: Crafting Complete and Effective Products for Your Business Needs.</p></div>
            <div className='py-3 flex items-center justify-start'><FaCheckSquare size={32} className='mr-4 text-b-800'/><p className='text-[20px]'>Streamlined Excellence: Your Partner in Simplifying Processes and Maximizing Results.</p></div>
