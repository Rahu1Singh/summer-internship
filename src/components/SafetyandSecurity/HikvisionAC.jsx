    ...
    return (
        <div className='relative bg-r-100 my-10 p-10 overflow-hidden flex'>
            <div className='relative w-full 2xl:w-1/2 flex flex-col items-center z-40 my-auto'>
                <img src={hikvisionlogo} className="h-[30px] xl:h-[50px] m-5" alt="Hikvision Logo"/>
                <div className="flex flex-col lg:w-2/3 my-3">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={facerecog} className="h-[50px] px-5" aria-hidden="true"/>
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={fingerprint} className="h-[50px] px-5" aria-hidden="true" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={barriergate} className="h-[50px] px-5" aria-hidden="true" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={tripod} className="h-[50px] px-5" aria-hidden="true" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={flap} className="h-[50px] px-5" aria-hidden="true" />
                        <div className="flex flex-col">
            ...
            <div className='absolute top-0 left-0 h-full w-[960px] z-0 bg-r-300' aria-hidden="true" />
            <div className='hidden lg:block absolute top-0 left-[90px] h-full w-[90px] z-10 bg-r-400' aria-hidden="true" />
            <div className='hidden lg:block absolute top-0 left-0 h-full w-[90px] z-20 bg-r-500' aria-hidden="true" />
        </div>
  )
}
