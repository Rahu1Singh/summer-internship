    ...
    return (
        <div className='relative my-10 p-10 overflow-hidden flex'>
            <div className='relative w-full 2xl:w-1/2 flex flex-col items-center z-40 my-auto'>
                <img src={hikvisionlogo} className="h-[30px] lg:h-[50px] m-5" alt="Hikvision Logo"/>
                <div className="flex flex-col lg:w-2/3 my-3">
                    <h1 className='text-lg font-medium text-r-900'>HIKVISION CCTV gives you</h1>
                    <div className="flex flex-row p-2 items-center">
                        <img src={cctv1} className="h-[50px] px-3" aria-hidden="true" />
                    ...
                    <div className="flex flex-row p-2 items-center">
                    <img src={cctv2} className="h-[50px] px-3" aria-hidden="true" />
                        <div className="flex flex-col">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={cctv3} className="h-[50px] px-3" aria-hidden="true" />
                        <div className="flex flex-col">
            ...
            <div className='absolute top-[150px] -right-[100px] h-[800px] w-[800px] z-20 rounded-[50%] bg-r-300' aria-hidden="true" />
            <div className='absolute top-[50px] -right-[200px] h-[1000px] w-[1000px] z-10 rounded-[50%] bg-r-400' aria-hidden="true" />
            <div className='absolute -top-[50px] -right-[300px] h-[1200px] w-[1200px] z-0 rounded-[50%] bg-r-500' aria-hidden="true" />
        </div>
    )
}
