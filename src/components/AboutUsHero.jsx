...
const AboutUsHero = () => {
    return (
        <div className='relative'>
            <div className="bg-g-100 w-full">
                <div id='AboutUs' className='flex bg-g-100 px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-40 py-8 md:py-16 ly:py-30 xl:py-50 2xl:py-40'>
                    <div id='heroContent' className='flex-1 relative flex flex-col items-start w-2/3 z-5'>
                        ...
                        <div className='py-4 flex items-center justify-start z-10'>
                            <p className='text-base xl:text-lg text-left text-b-950'> With years of experience in automation and engineering, our products <br/> have helped countless people around the world and solved their <br /> problems in the Automation & IT industry.
                            </p>
                        </div>
