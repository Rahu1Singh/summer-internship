                ...
                <div id='AboutUs' className='flex min-h-full px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-40 py-16 md:py-16 ly:py-30 xl:py-50 2xl:py-36'>
                    <div id='heroContent' className='flex-1 relative flex flex-col items-start lg:w-2/3 z-5'>
                        ...
                        <div className='py-4 flex items-center justify-start z-10 w-full md:w-1/2 2xl:w-full'>
                            <p className='md:text-[18px] xl:text-lg text-left text-b-950'> With years of experience in automation and engineering, our products  have helped countless people around the world and solved their problems in the Automation & IT industry.</p>
                        </div>
