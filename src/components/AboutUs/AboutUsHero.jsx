...
const AboutUsHero = () => {
    return (
        <div className='relative'>
            <div className="bg-b-100 w-full md:min-h-screen max-2xl:flex max-2xl:items-center">
                <div id='AboutUs' className='flex bg-b-100 my-auto px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-40 py-8 md:py-16 ly:py-30 xl:py-50 2xl:py-40'>
                    <div id='heroContent' className='flex-1 relative flex flex-col items-start w-2/3 z-5'>
                        <h1 className='pb-10 py-10 text-3xl md:text-5xl xl:text-6xl font-extrabold leading-tight text-left text-black'>
                        ...
                        <div className='py-4 flex items-center justify-start z-10 w-full md:w-1/2 2xl:w-full'>
                            <p className='text-[18px] xl:text-lg text-left text-black'> With years of experience in automation and engineering, our products  have helped countless people around the world and solved their problems in the Automation & IT industry.</p>
                        </div>
                        ...
                        <div className='pt-4 flex flex-col items-center md:items-start justify-start w-full'>
                            ...
                            <Button link="/products" className='bg-b-800 mr-2 md:mr-4 mb-4 md:mb-0 text-white rounded-3xl text-lg border-b-800 hover:bg-transparent hover:text-b-800 hover:font-bold'>
                            Check our products
                            </Button>
                            </div>
                        </div>
