...
const Whoweare = () => {
  return (
    <section className="relative my-5 px-2 lg:my-10">
      ...
      <div className="hidden lg:block absolute md:top-[50px] md:right-[140px] lg:top-[30px] lg:left-[30px] z-10 h-[750px] w-[450px] lg:h-[700px] lg:w-[700px] rounded-2xl bg-b-800" aria-hidden="true" />
    </section>
  )
}
