import { pmsimg , ecostruxurelogo } from "../../assets"
        ...
        <div className='relative bg-g-100 my-10 p-10 overflow-hidden flex'>
            <div className='relative w-full 2xl:w-1/2 xl:left-[15%] flex flex-col items-center xl:items-start z-40 my-auto'>
                ...
                <div className="flex flex-col lg:w-1/2">
                    <h1 className='text-lg font-medium text-g-900 my-3'>EcoStruxure Power Monitoring Expert gives you</h1>
                    <div className="flex flex-row p-2 items-center">
                        <img src={assets} className="h-[50px] mx-3"/>
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={growth} className="h-[50px] mx-3"/>
                        <div className="flex flex-col">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={lifecycle} className="h-[50px] mx-3"/>
                        <div className="flex flex-col">
                    ...
                    <div className="flex flex-row p-2 items-center">
                        <img src={compliance} className="h-[50px] mx-3"/>
                        <div className="flex flex-col">
            ...
            <div className='absolute top-0 left-0 h-full w-[960px] z-0 bg-g-200'/>
            <div className='absolute hidden lg:block top-0 left-[90px] h-full w-[90px] z-10 bg-g-300'/>
            <div className='absolute hidden lg:block top-0 left-0 h-full w-[90px] z-20 bg-g-400'/>
        </div>
    )
}
