...
const Domains = () => {
    return (
        <div id="domains" className="relative w-full bg-b-100 overflow-hidden flex flex-col items-center">
            <h1 className="z-10 text-4xl font-bold text-b-800 my-5">Who We Are</h1>
            <div id="whoweare" className="my-10 relative p-5 flex justify-center items-center w-full max-w-4xl">
                <Whoweare />
                <div className="absolute top-[50px] left-[50px] z-10 h-[666px] w-[747px] rounded-2xl bg-b-800" />
            </div>
            
            <div className="my-10 relative p-5 flex justify-center items-center w-full">
                <h1 className="z-10 text-[50px] leading-[56px] text-right w-1/3 font-bold text-b-800 my-5 px-20">Domains<br />We Serve</h1>
                <Domainsweserve />
            </div>
